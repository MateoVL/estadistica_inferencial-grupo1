...
# EP10
A partir de los datos del EP09, realizar un modelo de regresión logistica simple, eligiendo un predictor basandose en literatura, luego en base a los predictores elegidos aleatoriamente en el EP09, construir un modelo de regresión logística múltiple.
...
Esta condicion tampoco se cumple, ya que se detectó separación perfecta en varias iteraciones de la validación cruzada (LOOCV), evidenciada por las advertencias de convergencia del algoritmo. 
...
cat("\n\n--- Análisis de Sobreajuste (Entrenamiento vs Prueba) ---\n")
...
###6. Pronunciarse sobre la confiabilidad y capacidad predictiva de los modelos
